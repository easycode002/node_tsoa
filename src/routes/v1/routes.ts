...
const models: TsoaRoute.Models = {
    "ISupplier": {
        ...
        "properties": {
            ...
            "gender": {"dataType":"double","required":true},
    ...
    "SupplierResponse": {
        ...
        "properties": {
            ...
            "data": {"ref":"ISupplier","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // ###########################################################################################################
        ...
        app.post('/v1/supplier',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"SupplierCreateRequest"},
            };
        ...
        app.get('/v1/supplier',
            ...(fetchMiddlewares<RequestHandler>(SupplierController)),
            ...(fetchMiddlewares<RequestHandler>(SupplierController.prototype.getAllSupplier)),

            async function SupplierController_getAllSupplier(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
